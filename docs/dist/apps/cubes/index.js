...
function addNewCubeCharacter(scene, ground) {
  ...
  function move(direction) {
    mesh.applyImpulse(direction.normalize().scale(2), mesh.getAbsolutePosition().addInPlaceFromFloats(0, 0.5, 0));
  }

  const directions = [BABYLON.Vector3.Forward(), BABYLON.Vector3.Backward(), BABYLON.Vector3.Left(), BABYLON.Vector3.Right()];
